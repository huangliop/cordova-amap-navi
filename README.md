...
|loc|定位结果来源.LOCATION_TYPE_GPS = 1;LOCATION_TYPE_SAME_REQ = 2;LOCATION_TYPE_FAST = 3; LOCATION_TYPE_FIX_CACHE = 4; LOCATION_TYPE_WIFI = 5;LOCATION_TYPE_CELL = 6; LOCATION_TYPE_AMAP = 7;LOCATION_TYPE_OFFLINE = 8;|是|
|locD|信息描述|是|
|einfo|错误信息描述|
|ecode|错误码|
